    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <main className="max-w-7xl mx-auto px-8 py-10">
        ...
        <div className="flex items-end justify-between mb-8">
          ...
          {feedback && (
            <div className="bg-green-500/10 border border-green-500/30 text-green-400 text-sm px-4 py-2 rounded-lg font-mono">
              {feedback}
            </div>
          )}
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                { label: "RACES", value: stats.totalRaces, color: "text-green-400" },
              ].map(s => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    return (
                      <div key={role}>
                        <div className="flex justify-between text-xs mb-1">
                          <span className={`font-bold px-2 py-0.5 rounded border ${ROLE_COLORS[role as keyof typeof ROLE_COLORS]}`}>
                            {role}
                          </span>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  {[
                    { label: "Race Results Submitted", value: stats.totalRaceResults, icon: "🏁" },
            ...
            <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-6 w-full max-w-md">
              ...
              <div className="flex gap-3 mt-5">
                ...
                <button onClick={() => { setShowCreate(false); setCreateError(""); }}
                  className="flex-1 border border-zinc-700 text-zinc-400 hover:text-white py-2 rounded-lg text-sm transition-colors">
                  CANCEL
                </button>
              </div>
            </div>
            ...
            <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-6 w-full max-w-sm">
              ...
              <div className="flex gap-3">
                <button onClick={resetPassword} disabled={newPassword.length < 6}
                  className="flex-1 bg-blue-600 hover:bg-blue-500 disabled:bg-zinc-700 text-white font-bold py-2 rounded-lg text-sm transition-colors">
                  RESET
                </button>
