...
import {
  STRATEGY_COLORS, STRATEGY_NAMES, TYRE_PERF_DEFAULTS,
  type SavedPlan, type Stint, type Strategy, type TyreCompoundApi, type TyrePerfTable, type TyreType,
} from "./model";
import { CompoundChip, LapAxis, StintBar } from "./StrategyParts";
